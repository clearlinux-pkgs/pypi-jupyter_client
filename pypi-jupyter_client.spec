...
Source0  : https://files.pythonhosted.org/packages/2d/8b/4c9c3623608b31370f5dd02963801adc36a81ba95b8e1a1a4deacdd84973/jupyter_client-7.1.2.tar.gz
...
%prep
%setup -q -n jupyter_client-7.1.2
cd %{_builddir}/jupyter_client-7.1.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643042383
...
cp %{_builddir}/jupyter_client-7.1.2/COPYING.md %{buildroot}/usr/share/package-licenses/pypi-jupyter_client/8fd549f28c3423c251b3b70e91bdad2fbfe6ef30
