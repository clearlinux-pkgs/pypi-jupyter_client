...
Source0  : https://files.pythonhosted.org/packages/4d/d1/b6161a5e8639a0d35aeb59a50d944dc4928775db2408ea10b23087e354b6/jupyter_client-7.3.5.tar.gz
...
%prep
%setup -q -n jupyter_client-7.3.5
cd %{_builddir}/jupyter_client-7.3.5
pushd ..
cp -a jupyter_client-7.3.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661473319
