...
Version  : 7.4.1
Release  : 86
URL      : https://files.pythonhosted.org/packages/7c/cd/594599dd0f36fb33a4cc8baa5bf50ab18ac40adcd08e5664949f20f864cf/jupyter_client-7.4.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/7c/cd/594599dd0f36fb33a4cc8baa5bf50ab18ac40adcd08e5664949f20f864cf/jupyter_client-7.4.1.tar.gz
...
%prep
%setup -q -n jupyter_client-7.4.1
cd %{_builddir}/jupyter_client-7.4.1
pushd ..
cp -a jupyter_client-7.4.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665522259
