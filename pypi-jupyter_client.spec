...
Source0  : https://files.pythonhosted.org/packages/fc/26/809f5025845c84fd88553a5d0be505553c69ee4fd7e95d8efe803446c721/jupyter_client-7.4.4.tar.gz
...
%prep
%setup -q -n jupyter_client-7.4.4
cd %{_builddir}/jupyter_client-7.4.4
pushd ..
cp -a jupyter_client-7.4.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666741038
