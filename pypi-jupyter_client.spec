...
Source0  : https://files.pythonhosted.org/packages/d8/41/fddcf62081f88e06be196091beb41c07fe85562199d7439dfd3bf8c57601/jupyter_client-8.0.2.tar.gz
...
%prep
%setup -q -n jupyter_client-8.0.2
cd %{_builddir}/jupyter_client-8.0.2
pushd ..
cp -a jupyter_client-8.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675095761
