...
Source0  : https://files.pythonhosted.org/packages/6d/e4/669b78fa5905325f5ef4def0ee17a70729246b24f28de832926bb9bfcbb1/jupyter_client-7.1.1.tar.gz
...
%prep
%setup -q -n jupyter_client-7.1.1
cd %{_builddir}/jupyter_client-7.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642202632
...
cp %{_builddir}/jupyter_client-7.1.1/COPYING.md %{buildroot}/usr/share/package-licenses/pypi-jupyter_client/8fd549f28c3423c251b3b70e91bdad2fbfe6ef30
