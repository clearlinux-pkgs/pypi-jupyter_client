...
Source0  : https://files.pythonhosted.org/packages/1e/33/71778cdd2c69445bcd3bb6029da2e43cc9b5cbbeef4f4982ef3aaf396650/jupyter_client-7.4.9.tar.gz
...
%prep
%setup -q -n jupyter_client-7.4.9
cd %{_builddir}/jupyter_client-7.4.9
pushd ..
cp -a jupyter_client-7.4.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673625988
