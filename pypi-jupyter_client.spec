...
Source0  : https://files.pythonhosted.org/packages/ff/61/3cd51dea7878691919adc34ff6ad180f13bfe25fb8c7662a9ee6dc64e643/jupyter_client-8.6.2.tar.gz
...
%prep
%setup -q -n jupyter_client-8.6.2
cd %{_builddir}/jupyter_client-8.6.2
pushd ..
cp -a jupyter_client-8.6.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716481257
