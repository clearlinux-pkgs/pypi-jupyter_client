...
Version  : 7.4.2
Release  : 87
URL      : https://files.pythonhosted.org/packages/39/bd/03b670b7ae2e74f04ec42754d67223d4ea1208b2e597c2c553086a6a61cd/jupyter_client-7.4.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/39/bd/03b670b7ae2e74f04ec42754d67223d4ea1208b2e597c2c553086a6a61cd/jupyter_client-7.4.2.tar.gz
...
%prep
%setup -q -n jupyter_client-7.4.2
cd %{_builddir}/jupyter_client-7.4.2
pushd ..
cp -a jupyter_client-7.4.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665600222
