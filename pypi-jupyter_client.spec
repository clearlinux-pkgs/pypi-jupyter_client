...
%prep
%setup -q -n jupyter_client-7.2.2
cd %{_builddir}/jupyter_client-7.2.2
...
cp %{_builddir}/jupyter_client-7.2.2/COPYING.md %{buildroot}/usr/share/package-licenses/pypi-jupyter_client/8fd549f28c3423c251b3b70e91bdad2fbfe6ef30
