...
Source0  : https://files.pythonhosted.org/packages/cd/5a/f4583ba60733b5a1cb1379acdf7c710fb1fb4d9df936a740f8cadf25d853/jupyter_client-8.6.1.tar.gz
...
%prep
%setup -q -n jupyter_client-8.6.1
cd %{_builddir}/jupyter_client-8.6.1
pushd ..
cp -a jupyter_client-8.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710254438
