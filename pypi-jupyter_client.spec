...
Source0  : https://files.pythonhosted.org/packages/44/7e/66ddb15931e90d13097446a19d550e894a8f869ef4185d46aa6d719654ab/jupyter_client-7.4.5.tar.gz
...
%prep
%setup -q -n jupyter_client-7.4.5
cd %{_builddir}/jupyter_client-7.4.5
pushd ..
cp -a jupyter_client-7.4.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668447847
