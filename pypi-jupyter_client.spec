...
Version  : 7.2.0
Release  : 74
URL      : https://files.pythonhosted.org/packages/83/44/948b5690999d1fa0a4d9347051f4568a8769e69a8513a77f1b07d5342750/jupyter_client-7.2.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/83/44/948b5690999d1fa0a4d9347051f4568a8769e69a8513a77f1b07d5342750/jupyter_client-7.2.0.tar.gz
...
%prep
%setup -q -n jupyter_client-7.2.0
cd %{_builddir}/jupyter_client-7.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648659875
...
cp %{_builddir}/jupyter_client-7.2.0/COPYING.md %{buildroot}/usr/share/package-licenses/pypi-jupyter_client/8fd549f28c3423c251b3b70e91bdad2fbfe6ef30
