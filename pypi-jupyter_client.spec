...
Source0  : https://files.pythonhosted.org/packages/2c/d6/db61927064a9781d7e61163b3ea5f630d21a3af4bdeedb9d91738f9df487/jupyter_client-7.3.1.tar.gz
...
%prep
%setup -q -n jupyter_client-7.3.1
cd %{_builddir}/jupyter_client-7.3.1
pushd ..
cp -a jupyter_client-7.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653340018
...
cp %{_builddir}/jupyter_client-7.3.1/COPYING.md %{buildroot}/usr/share/package-licenses/pypi-jupyter_client/8fd549f28c3423c251b3b70e91bdad2fbfe6ef30
