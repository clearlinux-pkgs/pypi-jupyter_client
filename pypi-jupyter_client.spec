...
Version  : 7.4.6
Release  : 94
URL      : https://files.pythonhosted.org/packages/58/1b/30faa448e58827b17c00bc5e5ae21690753dbda85baad4d6aae2e6c8fe5a/jupyter_client-7.4.6.tar.gz
Source0  : https://files.pythonhosted.org/packages/58/1b/30faa448e58827b17c00bc5e5ae21690753dbda85baad4d6aae2e6c8fe5a/jupyter_client-7.4.6.tar.gz
...
%prep
%setup -q -n jupyter_client-7.4.6
cd %{_builddir}/jupyter_client-7.4.6
pushd ..
cp -a jupyter_client-7.4.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668526201
