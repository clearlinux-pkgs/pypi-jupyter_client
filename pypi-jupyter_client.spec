...
Source0  : https://files.pythonhosted.org/packages/77/d8/1627e06db1bd3b6907ee43eae38651848de6e57996370fff60c273366509/jupyter_client-8.4.0.tar.gz
...
%prep
%setup -q -n jupyter_client-8.4.0
cd %{_builddir}/jupyter_client-8.4.0
pushd ..
cp -a jupyter_client-8.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697036560
