...
%prep
%setup -q -n jupyter_client-7.3.4
cd %{_builddir}/jupyter_client-7.3.4
pushd ..
cp -a jupyter_client-7.3.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655941063
...
cp %{_builddir}/jupyter_client-7.3.4/COPYING.md %{buildroot}/usr/share/package-licenses/pypi-jupyter_client/8fd549f28c3423c251b3b70e91bdad2fbfe6ef30
