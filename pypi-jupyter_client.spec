...
Source0  : https://files.pythonhosted.org/packages/e5/6d/e0d0034826e61b8a0d6ba850e7765c1342045f8cf8934516a8ba2e57b679/jupyter_client-8.0.1.tar.gz
...
%prep
%setup -q -n jupyter_client-8.0.1
cd %{_builddir}/jupyter_client-8.0.1
pushd ..
cp -a jupyter_client-8.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674834786
...
cp %{_builddir}/jupyter_client-%{version}/COPYING.md %{buildroot}/usr/share/package-licenses/pypi-jupyter_client/fb64d95877332f1c79bc99f5506a064e7fe49fcf || :
...
/usr/share/package-licenses/pypi-jupyter_client/fb64d95877332f1c79bc99f5506a064e7fe49fcf
