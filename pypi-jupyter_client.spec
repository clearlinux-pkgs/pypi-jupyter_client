...
Source0  : https://files.pythonhosted.org/packages/1c/5e/0a37aa86e56ef815ca8ea4f2fb09386db2bbd19f733ee0fb977069fe7319/jupyter_client-7.3.0.tar.gz
...
%prep
%setup -q -n jupyter_client-7.3.0
cd %{_builddir}/jupyter_client-7.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650990545
...
cp %{_builddir}/jupyter_client-7.3.0/COPYING.md %{buildroot}/usr/share/package-licenses/pypi-jupyter_client/8fd549f28c3423c251b3b70e91bdad2fbfe6ef30
