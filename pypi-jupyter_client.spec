...
Source0  : https://files.pythonhosted.org/packages/bd/3d/a65f5f54ebaa2ad32eec08fc8ba471608dbb4a0cb0e91dc8d58ac3bdc3d4/jupyter_client-8.1.0.tar.gz
...
%prep
%setup -q -n jupyter_client-8.1.0
cd %{_builddir}/jupyter_client-8.1.0
pushd ..
cp -a jupyter_client-8.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679412457
